...
export const MapWithClusteringfactory = (Map, ClusteredMarker, SpiderMarker) => {
    ...
    const AnimatedSpiderMarker = animatedMarkerFactory(SpiderMarker);
     ...
     class MapWithClustering extends Component {
        ...
        getBounds(map) {
        	if(!map)
				return { bounds: { nw: { lat: 85, lng: -180 }, se: { lat: -85, lng: 180 } }, zoom: 2 };
